...
namespace Gifts_Store.Controllers
{
    public class BanksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Cardholdername,ExpirationDate,Cvv,Amount,CardNumber")] Bank bank )
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,Cardholdername,ExpirationDate,Cvv,Amount,CardNumber")] Bank bank)
        {
            if (id != bank.Id)
            {
                return NotFound();

...
namespace Gifts_Store.Controllers
{
    public class TestimonialsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Content,Namee,ImagePath,UserId,Status,DateTestimonial")] Testimonial testimonial)
        {
            ViewBag.AName = HttpContext.Session.GetString("AName");
            ViewBag.ID = HttpContext.Session.GetInt32("AdminId");
            ...
            ViewData["UserId"] = new SelectList(_context.Userrs, "Id", "Email", testimonial.UserId);
            return View(testimonial);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,Content,Namee,ImagePath,UserId,Status,DateTestimonial")] Testimonial testimonial)
        {
            ViewBag.AName = HttpContext.Session.GetString("AName");
            ViewBag.ID = HttpContext.Session.GetInt32("AdminId");
